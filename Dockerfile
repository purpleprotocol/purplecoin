...
ENV PURPLECOIN_NETWORK_LISTENPORT=8098
ENV PURPLECOIN_NETWORK_RPCENABLED=
ENV PURPLECOIN_NETWORK_RPCLISTENPORT=8067
...
ENV PURPLECOIN_NODE_BRDIGEPUBLICQUERIES=
ENV PURPLECOIN_NODE_BRIDGEHTTPQUERIES=
ENV PURPLECOIN_NODE_BRDIGEHTTPLISTENPORT=8080
