...
* [ ] Consensus layer
  ...
  * [ ] Implement VM opcodes
    ...
    - [ ] OP `0xa4` VerifyBIP340 - Takes the given public key and signature, and pushes them along with the current input's binary format to the BIP340 signature verification stack and stops script execution. For direct compatibility with Bitcoin Taproot.
