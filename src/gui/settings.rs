...
use crate::gui::{theme::Theme, Icon, Message, Tab};
...
impl TabSettings {
    pub fn new() -> Self {
        TabSettings {
            tab_bar_position: Some(TabBarPosition::default()),
    ...
    fn content(&mut self) -> Element<'_, Self::Message> {
        let content: Element<'_, SettingsMessage> = Container::new(
            Column::new()
                ...
                .push(TabBarPosition::ALL.iter().copied().fold(
                ...
                .push(Theme::ALL.iter().copied().fold(
                    Column::new().padding(10).spacing(10),
                    |column, theme| {
                        column.push(
                            Radio::new(
